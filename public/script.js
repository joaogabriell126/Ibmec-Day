document.addEventListener('DOMContentLoaded', () => {
    ...
    const puzzles = [
        { brandName: "Meta", logoFile: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Meta-Logo.png/1200px-Meta-Logo.png", requiredColors: ['orange'], revealedWord: "Nova" },
    ...
    const universalHint = "<strong>Dica:</strong> Talvez você deva pensar o contrário, ou melhor dizendo, o que for complementar. <br><strong>Observação:</strong> Algumas marcas podem possuir duas cores, por isso, será necessário usar duas cores.";
